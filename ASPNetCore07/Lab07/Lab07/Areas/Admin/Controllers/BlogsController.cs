...
namespace Lab07.Areas.Admin.Controllers
{
    ...
    public class BlogsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Status,CreatedDate,Image,Decription")] Blog blog)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Status,CreatedDate,Image,Decription")] Blog blog)
        {
            if (id != blog.Id)
            {
                return NotFound();
